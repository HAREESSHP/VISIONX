...
function initCountdown() {
    // Set the target date - April 10, 2026 at 5:00 PM
    const targetDate = new Date('April 10, 2026 17:00:00').getTime();
...
function initScrollReveal() {
    ...
    const revealElements = document.querySelectorAll(
        '.section-header, .about-text, .about-image, .event-card, .pre-event-card, .gallery-item, .stat'
    );
...
function openWhatsApp() {
    ...
    const message = 'Hi! I would like to register for VisionX Events (Cultural Day Concert & HR Excellence) on April 10-11, 2026.';
